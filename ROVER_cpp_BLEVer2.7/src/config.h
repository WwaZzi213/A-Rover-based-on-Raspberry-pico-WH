...
// ============================================================
//  HC-SR04 超声波传感器（正前方避障）
//  注意：HC-SR04 ECHO 输出 5V，需串联 1kΩ+2kΩ 分压至 3.3V
//        或使用 3.3V 供电版本，否则可能损坏 RP2040 IO
// ============================================================
#define ULTRASONIC_TRIG_PIN          9    // GPIO9  → HC-SR04 TRIG
#define ULTRASONIC_ECHO_PIN          10   // GPIO10 → HC-SR04 ECHO
#define OBSTACLE_STOP_DISTANCE_CM    20   // 前方障碍物急停阈值（cm）
